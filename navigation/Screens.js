...
import RacialResources from "../screens/racialResources";
import Finance from "../screens/4Buttons/FinancialResources";
import ChatApp from "../screens/4Buttons/Community";
...
function RacialMinoritiesStack(props) {
  return (
    <Stack.Navigator
      initialRouteName="racialResources"
      screenOptions={{
        headerShown: false, // Hide the default header for all screens
      }}
    >
      <Stack.Screen
        name="racialResources"
        component={RacialResources}
        options={{ title: "Home" }}
      />
      <Stack.Screen name="financialResources" component={Finance} />
...
function AppStack(props) {
  return (
    ...
    >
      ...
      <Drawer.Screen
        name="racialResources"
        options={{ title: "Resources for Minorities" }}
        component={RacialMinoritiesStack}
      />
      <Drawer.Screen
        name="financialResources"
        options={{ title: "Financial Resources" }}
        component={RacialMinoritiesStack}
      />
      <Drawer.Screen
        name="Settings"
